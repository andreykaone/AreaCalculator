...
namespace AreaCalculator.Shapes
{
   ...
   /*
    * Выделил абстрактный класс, следуя принципу подстановк Liskov ( SOLID ), чтобы у нас была возможность расширять базовый функционал библиотеки
    */
    ...
    * чтобы клиенты могли пользоваться только public свойствами, им предоставленными (рефлексию в расчет не берём), скрывая от них детали реализации.
